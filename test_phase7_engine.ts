...
import { AccountService } from './src/core/services/AccountService.ts';
...
async function runPhase7Tests() {
  ...
  try {
    ...
    const cogsAcc = accounts.find(a => a.code === '5101') || accounts[3];
    ...
    try {
      await JournalEngine.postJournalEntry(
        ...
        [
          ...
          { accountId: salesAcc.id, debit: 0, credit: 500 } // Diff 500!
        ],
        { status: 'posted' }
      );
    } catch (err: any) {
