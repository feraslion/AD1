...
router.get('/workflows/rules', authorize(['manager']), (req, res) => {
...
// 3. Notifications
router.get('/notifications', authorize(['manager', 'accountant', 'cashier', 'inventory']), async (req, res) => {
...
router.post('/notifications/read-all', authorize(['manager', 'accountant', 'cashier', 'inventory']), (req, res) => {
