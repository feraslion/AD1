        ...
        <div className="p-4 sm:p-5 space-y-4 overflow-y-auto flex-1">
          ...
          <div className="bg-slate-50 dark:bg-slate-800/50 p-3.5 rounded-xl border border-slate-200 dark:border-slate-700/60 space-y-3">
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              <div>
                <label htmlFor="share-customer-name" className="block text-xs font-bold text-slate-700 dark:text-slate-300 mb-1">
                  اسم المستلم / العميل:
                </label>
                <input
              ...
              <div>
                <label htmlFor="share-phone-number" className="block text-xs font-bold text-slate-700 dark:text-slate-300 mb-1">
                  رقم الواتساب / الهاتف:
                </label>
                <input
                  ...
                  className="w-full px-3 py-2 bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-700 rounded-lg text-xs font-mono font-bold text-slate-800 dark:text-slate-100 focus:outline-none focus:border-emerald-500 text-left dir-ltr focus-visible:ring-2 focus-visible:ring-emerald-500 outline-none"
                />
              </div>

              <div>
                <label htmlFor="share-customer-email" className="block text-xs font-bold text-slate-700 dark:text-slate-300 mb-1">
                ...
                <input
                  ...
                  className="w-full px-3 py-2 bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-700 rounded-lg text-xs font-mono text-slate-800 dark:text-slate-100 focus:outline-none focus:border-emerald-500 text-left dir-ltr focus-visible:ring-2 focus-visible:ring-emerald-500 outline-none"
                />
              </div>
            </div>
            ...
            {customers.length > 0 && (
              <div className="pt-2 border-t border-slate-200 dark:border-slate-700/60 flex items-center gap-2">
                <label htmlFor="share-customer-select" className="text-xs font-bold text-slate-500 shrink-0">اختيار سريع:</label>
                <select
                  id="share-customer-select"
                  onChange={e => {
          ...
          {/* Template Selection */}
          <div>
            <label id="template-label" className="block text-xs font-bold text-slate-700 dark:text-slate-300 mb-2">
              نوع وشكل النص المرفق:
            </label>
            <div role="group" aria-labelledby="template-label" className="grid grid-cols-2 sm:grid-cols-5 gap-1.5">
              <button
                onClick={() => setMessageTemplate('invoice')}
                className={`py-2 px-2 rounded-lg text-xs font-bold transition border text-center focus-visible:ring-2 focus-visible:ring-emerald-500 outline-none ${
          ...
          <div>
            <div className="flex items-center justify-between mb-1">
              <label htmlFor="share-custom-message" className="text-xs font-bold text-slate-700 dark:text-slate-300">
                محتوى الرسالة:
              </label>
              <button
            ...
            {messageTemplate === 'custom' ? (
              <textarea
                ...
                className="w-full h-24 p-3 bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-700 rounded-xl text-xs text-slate-800 dark:text-slate-100 focus:outline-none focus:border-emerald-500 resize-none focus-visible:ring-2 focus-visible:ring-emerald-500"
              />
            ) : (
          ...
          <div className="pt-2 border-t border-slate-200 dark:border-slate-800">
            ...
            {/* WHATSAPP TAB */}
            {activeTab === 'whatsapp' && (
              <div id="panel-whatsapp" role="tabpanel" aria-labelledby="tab-whatsapp" className="space-y-3 bg-emerald-500/5 p-4 rounded-xl border border-emerald-500/20">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    <MessageCircle className="w-5 h-5 text-emerald-500" aria-hidden="true" />
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                  <a
                    ...
                    className="py-3 px-4 bg-emerald-600 hover:bg-emerald-500 text-white rounded-xl font-black text-xs transition flex items-center justify-center gap-2 shadow-lg shadow-emerald-600/20 focus-visible:ring-2 focus-visible:ring-emerald-500 outline-none"
                  >
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="py-3 px-4 bg-slate-800 hover:bg-slate-700 text-white rounded-xl font-bold text-xs transition flex items-center justify-center gap-2 focus-visible:ring-2 focus-visible:ring-emerald-500 outline-none"
                  >
            ...
            {/* TELEGRAM TAB */}
            {activeTab === 'telegram' && (
              <div id="panel-telegram" role="tabpanel" aria-labelledby="tab-telegram" className="space-y-3 bg-sky-500/5 p-4 rounded-xl border border-sky-500/20">
                <div className="flex items-center gap-2">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-full py-3 px-4 bg-sky-500 hover:bg-sky-400 text-white rounded-xl font-black text-xs transition flex items-center justify-center gap-2 shadow-lg shadow-sky-500/20 focus-visible:ring-2 focus-visible:ring-emerald-500 outline-none"
                >
            ...
            {/* GMAIL TAB */}
            {activeTab === 'gmail' && (
              <div id="panel-gmail" role="tabpanel" aria-labelledby="tab-gmail" className="space-y-3 bg-rose-500/5 p-4 rounded-xl border border-rose-500/20">
                <div className="flex items-center gap-2">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="py-3 px-4 bg-rose-600 hover:bg-rose-500 text-white rounded-xl font-black text-xs transition flex items-center justify-center gap-2 shadow-lg shadow-rose-600/20 focus-visible:ring-2 focus-visible:ring-emerald-500 outline-none"
                  >
            ...
            {/* DRIVE TAB */}
            {activeTab === 'drive' && (
              <div id="panel-drive" role="tabpanel" aria-labelledby="tab-drive" className="space-y-3 bg-amber-500/5 p-4 rounded-xl border border-amber-500/20">
                <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className="w-full py-3 px-4 bg-amber-600 hover:bg-amber-500 text-white rounded-xl font-black text-xs transition flex items-center justify-center gap-2 shadow-lg shadow-amber-600/20 focus-visible:ring-2 focus-visible:ring-emerald-500 outline-none"
                >
            ...
            {/* NATIVE SHARE TAB */}
            {activeTab === 'native' && (
              <div id="panel-native" role="tabpanel" aria-labelledby="tab-native" className="space-y-3 bg-indigo-500/5 p-4 rounded-xl border border-indigo-500/20">
                <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className="w-full py-3 px-4 bg-indigo-600 hover:bg-indigo-500 text-white rounded-xl font-black text-xs transition flex items-center justify-center gap-2 shadow-lg shadow-indigo-600/20 focus-visible:ring-2 focus-visible:ring-emerald-500 outline-none"
                >
