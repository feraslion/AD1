...
export async function seedEnterpriseData() {
  ...
  const defaultAccounts = [
    ...
    { id: 'acc_receivable', code: '1103_rec', name: 'الذمم المدينة للعملاء', type: 'asset', currency: 'SAR', companyId: 'company-1', balance: '0' },
    ...
    { id: 'acc_payable', code: '2101_pay', name: 'الذمم الدائنة للموردين', type: 'liability', currency: 'SAR', companyId: 'company-1', balance: '0' },
    { id: 'acc_vat_payable', code: '2102', name: 'ضريبة القيمة المضافة', type: 'liability', currency: 'SAR', companyId: 'company-1', balance: '0' },
    { id: 'acc_tax', code: '2102_tax', name: 'ضريبة القيمة المضافة المستحقة', type: 'liability', currency: 'SAR', companyId: 'company-1', balance: '0' },
